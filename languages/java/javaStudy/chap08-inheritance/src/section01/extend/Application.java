...
public class Application {
	...
	public static void main(String[] args) {
		...
		/* 상속(inheritace)은 현실 세계의 상속과 비슷한 개념이다.
		 ...
		 *   1-1. 재사용 시 생산성을 크게 향상시킬 수 있다.(새롭게 작성하는것 보다 빠르다)
		 *   1-2. 공통적으로 사용하는 코드가 부모클래스에 존재하면 수정사항이 생길 시 
		 *        부모 클래스만 수정해도 전체 적용된다.(유지보수성 증가)
		 ...
		 * 
		 * 장점과 단점을 고려했을 때
		 * 상속은 재상이라는 장점만 바라보게 되면 오용의 가능성이 있기 때문에 유지보수에 좋지 않는 코드를 작성할 확륭이 높다.
		 ...
		 * 
		 * 부모클래스 추상화 하는 경우에는 역할의 관점으로 바라봐야 한다.
		 ...
		 * Racing is a Car(0) / Car is a Racing(x)
		 * 
		 * 이러한 관계가 성립되는 것을 is a 관계라고 한다.
		 * is a 관계가 성룁되는 경우에 상속을 사용할 수 있다.
		 * */
		System.out.println("");
