...
public class Application01 {
	...
	public static void main(String[] args) {
		// 논리 연산자
		/*논리값 (true 혹은 false)를 취급하는 연산자 이다.
		 * 
		 * 논리 연산자의 종류
		 * 	1. 논리 연결 연산자 : 두 개의 피연산자를 가지는 이항 연산자이며, 연산자의 결함 방향이 왼쪽에서 오른쪽이다.
		 * 	  1-1. &&(논리 and) 연산자 : 두 개의 논리식 모두 참 일 경우 참을 반환, 둘 중 한 개라도 거짓인 경우 거짓을 반환
		 * 	  1-2. ||(논리 OR)  연산자 : 두 개의 논리식 중 둘 중 하나라도 참 일 경우 참을 반환, 둘 다 모두 거짓일 경우 거짓을 반환
		...
		System.out.println("true와 false의 놀리  and 연산 : " + (true && false));
