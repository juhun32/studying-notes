...
public class Application03 {
	...
	public static void main(String[] args) {
		 ...
		 * 요소를 꺼내올 때는 get을 사용하며, 인자로 전달하는 정수는 인덱스처럼 사용하면 된다.
		 * */
		...
		// set() 메소드를 이용해서 요소를 수정할 수 있따.
		linkedList.set(0, "fineapple");
		// toString() 메소드가 오버라이딩 되어 있어서 모든 요소를 볼 수 있다.
		System.out.println(linkedList);
		
		// isEmpty() 메소드를 이용해서 list가 비어있는지 확인 할 수 있따.
		System.out.println(linkedList.isEmpty());
	
		// 리스트 내 요소를 모두 제거하는 clear() 메소드를 이요할 수 있다.
		linkedList.clear();
